...
export const AVAILABILITY_MESSAGES = {
  HEADER_TITLE: "Add Your Availability",
  NO_SLOTS_SELECTED: "No time slots selected",
  CLEAR_SELECTION: "Clear selection",
  SELECT_BEST_TIMES: "Select best times",
  TOGGLE_GROUP_VIEW: "Show group availability",
} as const;